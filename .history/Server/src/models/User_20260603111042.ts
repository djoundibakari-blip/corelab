...
// pre save permet le hachage du mot de passe avant de le stocker dans la base de données, assurant ainsi une meilleure sécurité des données utilisateur. En utilisant bcrypt, le mot de passe est transformé en une chaîne de caractères sécurisée qui ne peut pas être facilement inversée, protégeant ainsi les informations sensibles des utilisateurs en cas de violation de données.
  try {
