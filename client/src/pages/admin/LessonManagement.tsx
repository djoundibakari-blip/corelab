...
export const LessonManagement = () => {
  ...
  const handleSaveLesson = async () => {
    ...
    try {
      ...
      // Update local state
      setLessons(lessons.map(l => l._id === editingLesson._id ? editingLesson : l));
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Modifiez le contenu pédagogique des cours.
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4">
        ...
        <select
          ...
          className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-600 transition"
        >
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-600 transition"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <textarea
                          ...
                          rows={6}
                          className="w-full px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-600 transition font-mono"
                        />
                      </div>
                      <div className="flex gap-2">
                        <button
                          ...
                          disabled={saving}
                          className="flex items-center gap-1.5 px-4 py-2 bg-green-600 hover:bg-green-700 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-4 py-2 border border-gray-200 hover:bg-gray-50 text-gray-600 text-sm font-medium rounded-lg transition-colors"
                        >
                          <X className="w-4 h-4" />
                          Annuler
                        </button>
